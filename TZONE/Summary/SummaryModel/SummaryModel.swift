...
struct SummaryModel : Codable {
    ...
    let prices_services : [SummaryPrices_services]?
    let total : Int?
    let total_days : Int?
    let car_id : String?
    let mem_id : String?
    let car_detailes : SummaryCar_detailes?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case prices_services = "prices_services"
        case total = "total"
    ...
    init(from decoder: Decoder) throws {
        ...
        prices_services = try values.decodeIfPresent([SummaryPrices_services].self, forKey: .prices_services)
        ...
        car_detailes = try values.decodeIfPresent(SummaryCar_detailes.self, forKey: .car_detailes)
...
struct SummaryPrices_services : Codable {
    let name : String?
    let price : Int?
...
struct SummaryCar_detailes : Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        images = try values.decodeIfPresent([SummaryImages].self, forKey: .images)
    }
